    ...
    $.extend(Countdown.prototype, {
        ...
        _generateHTML: function (c) {
            ...
            var n = function (a) {
                ...
                return ((!c.options.significant && h[a]) || (c.options.significant && j[a]) ? '<div class="' + x._sectionClass + '">' + '<span class="' + x._amountClass + '">' + d._translateDigits(c, c._periods[a]) + '<p>' + (b ? b[a] : k[a]) + '</p></span></div>' : '')
            };
