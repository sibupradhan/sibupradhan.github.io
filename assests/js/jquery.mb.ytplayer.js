$(window).load(function () {
    ...
    if (e == false) {
        ...
        $("#bg-video-volume").click(function (e) {
            var n = $(this);
            e.preventDefault();
            if (n.hasClass("icon exit-mute-1")) {
                n.removeClass("icon exit-mute-1").addClass("icon exit-volume-2").attr("title", "Mute");
                t.unmuteYTPVolume();
                t.setYTPVolume(100)
            } else {
                n.removeClass("icon exit-volume-2").addClass("icon exit-mute-1").attr("title", "Unmute");
                t.muteYTPVolume()
            }
        });
        $("#bg-video-play").click(function (e) {
            var n = $(this);
            e.preventDefault();
            if (n.hasClass("icon exit-pause")) {
                n.removeClass("icon exit-pause").addClass("icon exit-play").attr("title", "Play");
                t.pauseYTP()
            } else {
                n.removeClass("icon exit-play").addClass("icon exit-pause").attr("title", "Pause");
                t.playYTP()
            }
        })
    } else {
